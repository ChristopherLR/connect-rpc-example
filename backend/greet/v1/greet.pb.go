...
const file_greet_v1_greet_proto_rawDesc = "" +
	...
	"\bgreeting\x18\x01 \x01(\tR\bgreeting2\x92\x01\n" +
	"\fGreetService\x12:\n" +
	"\x05Greet\x12\x16.greet.v1.GreetRequest\x1a\x17.greet.v1.GreetResponse\"\x00\x12F\n" +
	"\x0fStreamGreetings\x12\x16.greet.v1.GreetRequest\x1a\x17.greet.v1.GreetResponse\"\x000\x01B.Z,example.com/connect-example/greet/v1;greetv1b\x06proto3"
...
var file_greet_v1_greet_proto_depIdxs = []int32{
	...
	0, // 1: greet.v1.GreetService.StreamGreetings:input_type -> greet.v1.GreetRequest
	1, // 2: greet.v1.GreetService.Greet:output_type -> greet.v1.GreetResponse
	1, // 3: greet.v1.GreetService.StreamGreetings:output_type -> greet.v1.GreetResponse
